...
<body>
	...
	<div id="container">
		...
		<div id="content">
			<div class="title">
<font size="+2"><P ALIGN="CENTER"><B>EDYCJA NUMERU LINII</B></P></font>
</div>
<?php
$plik = 'rozklad/linie';
...
<center><textarea name="tresc" cols="10" rows="20">'.file_get_contents($plik).'</textarea><p>
<input type="submit" value="Zapisz"></center>
</form>';
?>
</body>
</html>
