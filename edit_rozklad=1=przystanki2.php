...
?> </td>  
<td> <?php
$plik2 = 'rozklad/1/przystanki_2';
if(isset($_POST['tresc2'])){
    file_put_contents($plik2, $_POST['tresc2']);
}

echo '<form action="'.$_SERVER['PHP_SELF'].'" method="post">
<center><textarea name="tresc2" cols="35" rows="35">'.file_get_contents($plik2).'</textarea>
<p><input type="submit" name="form2" value="Zapisz2"></center>
</form>';
