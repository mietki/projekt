...
<div class="divA">
<div class="title">
<font size="+2"><P ALIGN="CENTER">EDYCJA KOMUNIKATU</P></font>
</div>
<div class="divB">
<div class="divD">
...
echo "<b><a href='edit_komunikat2.php?update={$row['id_kom']}'>{$row['nazwa']}</a></b>";
echo "<br />";
}
?>
</div><?php
...
<Span>Komunikat został zaktualizowany</span></div>';
}
?>
<div class="clear"></div>
</div>
